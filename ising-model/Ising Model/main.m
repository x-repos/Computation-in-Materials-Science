...
figure(1), plot(T1, M1, 'ro'), title('Magnetization');xlabel('T');ylabel('M');
figure(2), plot(T1, CV, 'ro'), title('Specific heat');xlabel('T');ylabel('CV');
figure(3),plot(T1, CHI, 'ro'), title('Succeptibbility');xlabel('T');ylabel('CHI');
fclose all
